...
const copy = {
  ...
  guideResult: "\u57fa\u4e8e\u539f\u753b\u4f18\u5316",
  guidePlan: "\u8c03\u6574\u65b9\u6848",
  strengthAnalysis: "分析孩子优势",
  strengthSubtitle: "从心理学·成长规律·家庭美育看见孩子",
  strengthFormulaLabel: "家庭美育模型",
...
function buildStrengthInsights(analysis) {
  ...
  const familyInsight = hasDetail
    ? `作品线条观察认真、细节丰富——这在家庭美育体系中是「过程投入」的明确信号。孩子可能在画画时进入了心流状态：全神贯注、忘记时间、自我驱动。家长要做的不是急着纠正，而是保护这份专注力，这是比「画得像」更珍贵的品质。`
    : isSimple
      ? `画面简洁不等于「画得少」。孩子能够抓住最核心的轮廓和关系，这是一种概括能力。在优势视角下，这可能是「成长型优势」——孩子有潜力，只是需要更多机会和自由空间去发展。不要急着让孩子填满画面，给孩子时间。`
      : `可以继续观察孩子在画中反复出现的主题、形状或颜色。这些「自然而然、反复出现」的绘画行为，按照家庭美育体系，正是孩子天赋的线索。从这些线索出发，提供环境让孩子有更多机会去深化，天赋就能变成真正的优势。`;
...
function buildTalentProfile(analysis, aiTalentName = null) {
  ...
  const talentDB = {
    emotional: {
      ...
      desc: "孩子通过绘画自然地表达和处理情感。在家庭美育体系中，「表达即疗愈，共鸣即疗愈」——画画是孩子天生的情感语言。课程强调右脑是情绪脑，艺术是打开右脑的钥匙。孩子不一定能用语言说清感受，但可以在画里尽情倾诉。",
      growth: [
    ...
    focus: {
      ...
      desc: "孩子画画时能够进入深度专注的心流状态。课程详细描述了心流体验的六个标准：全神贯注、行动和注意力融合、自我意识消失、有自我控制感、时间过得很快、有内在奖赏感。专注力是孩子最珍贵的学习品质，比任何技巧都重要。",
      growth: [
    ...
    endurance: {
      ...
      desc: "孩子面对绘画任务时展现出坚持到底的品质。课程强调「过程投入」线索——孩子愿意花时间把一件事做到自己满意。耐力和持续力不是天赋中最耀眼的那一个，但它是所有天赋转化为优势的「传送带」——没有它，再好的天赋也只能停留在表面。",
      growth: [
    ...
    story: {
      ...
      desc: "孩子不是在画单个物体，而是在「导演」一个场景。课程中提到「有的孩子边画边讲，甚至手舞足蹈」。课程建议用「谁、何时、何地、与谁、做什么」五个问题引导孩子把故事讲完整。故事天赋意味着孩子具有叙事思维——能看到事件之间的关联和因果。",
      growth: [
    ...
    design: {
      ...
      desc: "孩子不满足于复制现实，总想按自己的想法改造世界。课程中描述「有的孩子乐于将看见的物体进行再设计——把蜗牛壳设计成交叉线而不是螺旋线」。这不是「画错了」，而是一种高级思维——孩子不是观察者，而是创造者。课程中的「概念蜗牛」就是设计天赋的体现。",
      growth: [
    ...
    humor: {
      ...
      desc: "孩子用画笔制造快乐——这是一种高级的社交和情感能力。课程强调「接纳恶搞和小动作」——这些行为的背后是心理表达，有积极的心理意义。幽默天赋的孩子通常情商高、人际关系好，他们用笑声连接自己和他人。课程中说「涂鸦就是玩和表达的结合」——幽默天赋把这种「玩」发挥到了极致。",
      growth: [
    ...
    animal: {
      ...
      desc: "孩子与动物有特殊的情感连接。课程中提到「孩子会很自然地和一些小动物产生共鸣和共情，画出来的动物也会代表他们自己」「男孩往往喜欢狗，女孩往往喜欢猫」。画动物天赋体现了孩子的观察力、共情力和对生命的热爱。课程中的「共鸣投射」概念——孩子喜欢的动物往往承载了他的自我认同。",
      growth: [
    ...
    color: {
      ...
      desc: "孩子用色彩思考和表达。课程中「有的孩子对色彩敏感而忽略形体」「情绪愉快时画出五彩缤纷的色彩」「情绪激烈时选用大红色」。课程强调色彩是孩子的右脑语言——每一种颜色的选择背后都有情绪和感受。课程中的「象征投射」概念——孩子用颜色表达内心状态。",
      growth: [
    ...
    math: {
      ...
      desc: "孩子通过绘画展现了数学思维能力。课程虽然主要以美术为切入点，但课程中的「聚焦型学习风格」和结构化思维正是数学智能的体现。课程提到的「有的孩子可以画出形状准确的蜗牛」「关注轮子有几个」——这些都是数学思维在绘画中的自然流露。加德纳多元智能理论也把数学-逻辑智能列为独立维度。",
      growth: [
    ...
    logic: {
      ...
      desc: "孩子通过绘画展现了逻辑推理能力。课程中的「男孩关注轮子有几个、炮管多长、驾驶舱在哪——用画笔理解这个东西是怎么工作的」正是逻辑智能的体现。课程还提到「男孩充满创造性，女孩充满建设性」——这里的「建设性」很大程度上就是逻辑性。逻辑智能让孩子能够理解事物的运行规律，这是科学思维的基石。",
      growth: [
    ...
    spatial: {
      ...
      desc: "孩子能够理解和表现三维空间。课程中「有的孩子空间表达能力很强，物体之间的结构表现得很清晰」——这正是空间智能。课程中的「搭建类玩具让孩子空间思维能力得到锻炼，画画的时物体之间的结构都表现得很清晰」案例说明了空间智能是可培养的。在加德纳多元智能理论中，空间智能是最直接关联绘画的天赋。",
      growth: [
    ...
    mechanical: {
      ...
      desc: "孩子对机械结构有超出同龄人的理解力。这是课程中最核心的案例——「爱画打仗的小男孩」就是典型的机械智能天赋。课程中的妈妈最初担心孩子只画军事内容是不是心理问题，但转换优势视角后，发现这是「聚焦型学习风格」——孩子通过反复描绘机械来构建对世界的理解。「始于天赋，终于优势」——给孩子提供环境支持，这将是巨大的优势。",
      growth: [
  ...
  return {
    ...
    summary: useGenericFallback
      ? "按照家庭美育体系，天赋是孩子「自然而然、反复出现」的思维或行为模式。单幅作品只能提供观察线索，真正的天赋识别需要多看几幅画的纵向对比。请继续上传更多作品来获得更准确的分析。"
      : `按照家庭美育体系，天赋是孩子「自然而然、反复出现、可被高效利用」的思维或行为模式。从当前作品来看，孩子的画面特征（${matched.traits}）与「${matched.name}」高度吻合。这不是给孩子贴标签，而是帮助家长从优势视角理解孩子的发展方向。`,
  };
}
...
function buildProjectionObservations(analysis) {
  ...
  return {
    ...
    disclaimer: "以上观察基于家庭美育体系中的投射分析框架。绘画像一面镜子，可能投射孩子的经验、情绪和需求，但不能凭一张画下结论。使用「可能」「可以观察」「可以问问孩子」的态度，比急于判断更重要。",
  };
}
...
export function App() {
  ...
  function handleExport() {
    ...
    anchor.href = url;
    anchor.download = `点评_${fileName}_${new Date().toLocaleDateString("zh-CN").replace(/\//g, "-")}.txt`;
    anchor.click();
      ...
      <div className="upload-flow">
        ...
        <div className="flow-step interactive-card reveal-up" data-reveal>
          ...
          <div className="age-selector">
            ...
            <p className="age-selector-hint">选择年龄段后，分析将结合家庭美育体系按年龄精准解读</p>
          </div>
        </div>
